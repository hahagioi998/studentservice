...
List<Kecheng> kecheng_list=(ArrayList<Kecheng>)request.getAttribute("kecheng_list");
List<Student_kecheng> student_kecheng_list=(ArrayList<Student_kecheng>)request.getAttribute("student_kecheng_list");
       ...
       <div style="width:1140px;margin:0 auto;height:505px;">
          <div style="overflow-y:scroll;float:left;width:300px;max-height:800px;min-height:200px;padding: 30px 25px 0px;background: #fff;border-radius: 3px;text-align: center;margin-right:10px;">
             <form method="post" action="">
              ...
              <%if(!student_kecheng_list.isEmpty()){
	    	    for(Student_kecheng map:student_kecheng_list){
	    	    	 ...
	    	    	 Teacher_kecheng teacher_kecheng=NewsService.getTeacher_kechengByKecheng_id(kecheng.getId());
             ...
             <div style="margin:5px 0 5px 0;background: #f8f8f8;width: 100%;height: 50px;border-radius: 8px;padding: 5px;">
               <a href="${pageContext.request.contextPath}/Student_mykecheng_xiangqin?kecheng_id=<%=map.getKecheng_id()%>"target="kecheng_xiangqinFrame">
