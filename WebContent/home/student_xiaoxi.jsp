       ...
       <div style="width:1200px;margin:0 auto;min-height:175px;border-radius: 3px;">
           <%if(!tongzhi_list.isEmpty()){
	    	    for(Tongzhi map:tongzhi_list){
	    	        ...
	    	        Teacherusers teacher=UserService.chauserTeacher(map.getSender());
	    	    ...
	    	    %>
	    	<a href="${pageContext.request.contextPath}/Student_xiaoxi_xiangqin?xiaoxi_id=<%=map.getId()%>">
           <div style="margin:10px;background:#fff;height:60px;">
              <div style="float:left;width:60px;height:60px;margin: 5px;"><img src=""style="width: 50px;height: 50px;"></div>
