 ...
 */
@WebServlet("/Student_mykecheng_xiangqin")
public class Student_mykecheng_xiangqin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Student_mykecheng_xiangqin() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("home/student_home_mykecheng_kuang.jsp").forward(request, response);
	}
