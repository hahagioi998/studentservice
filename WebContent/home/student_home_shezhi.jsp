    ...
    <div style="width:100%;height:760px;background:#f8f8f8;">
       ...
       <div style="width:1140px;margin:0 auto;height:505px;">
          <div style="float:left;width:200px;height:250px;padding: 30px 25px 0px;background: #fff;border-radius: 3px;text-align: center;margin-right:10px;">
             <img src="${pageContext.request.contextPath}/<%=user.getImg() %>" style="width: 80px;height: 80px;border-radius: 50%;margin: 0 auto;">
              <p><%=user.getName() %></p>
             <p><%=user.getZhuanye() %></p>
             <p><%=user.getNianji() %>级<%=user.getCla() %>班</p>
          </div>
             ...
             <div style="padding: 70px 0px 10px;width:370px;height:390px;margin: 0 auto;" id="geren_kuang">
                  <form method="post" action="" style="width:370px;height:375px;">
                     <div style="margin-bottom: 10px;height:36px;width:760px">
                        ...
                        <div style="float:left"><input placeholder="请输入姓名" type="text" name="" value="<%=user.getName() %>" style=" height: 36px;padding-left: 10px;font-size: 14px;display: inline-block;border-radius: 3px;line-height: 36px;background: #fff;border: #dcdcdc solid 1px;"></div>
                     </div>  
                     <div style="margin-bottom: 10px;height:36px;width:760px">
                        <div style="float:left;width:100px;text-align: right;padding-right: 5px;height: 36px;line-height: 36px;">qq</div>
                        <div style="float:left"><input placeholder="请输入qq号" type="text" name="" value="<%=user.getQq() %>" style=" height: 36px;padding-left: 10px;font-size: 14px;display: inline-block;border-radius: 3px;line-height: 36px;background: #fff;border: #dcdcdc solid 1px;"></div>
                     </div>
                     <div style="margin-bottom: 10px;height:36px;width:760px">
                        <div style="float:left;width:100px;text-align: right;padding-right: 5px;height: 36px;line-height: 36px;">手机号</div>
                        <div style="float:left"><input placeholder="请输入手机号" type="text" name="" value="<%=user.getPhone() %>" style=" height: 36px;padding-left: 10px;font-size: 14px;display: inline-block;border-radius: 3px;line-height: 36px;background: #fff;border: #dcdcdc solid 1px;"></div>
                     </div>
              ...
              <div style="display:none;width: 370px;text-align: center;margin: auto;padding:70px 0 10px;height:390px" id="touxiang_kuang">
                  <form id="uploadForm" action="${pageContext.request.contextPath}/Tou" method="post" name="tou" enctype="multipart/form-data">
		             <center style="height:250px"><img src="${pageContext.request.contextPath}/<%=user.getImg() %>" alt="" id="selectImg" style="width:180px;height:180px;margin-top:10px;border-radius: 50%"></center>
